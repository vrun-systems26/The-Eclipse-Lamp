...
the Pi case but I couldn't center the servo for poper shaft rotation; 150mm finally fit both. I then switched to Tinkercad to
cut a cable-routing hole by the Pi's power port and a hidden rear hole to relocate the lamp switch somewhere reachable, and 
made wall thickness uneven so they could support the top's weight better without sagging. Print time became the next problem:
